...
This summary explains what gets "unlocked" when IF we reach these levels by Dec 15, courtesy __Le Parisien__.
...
![Daily new cases](/assets/images/2020/25_11_2020_daily_new_cases_owid.png)
...
![ICU occupancy](/assets/images/2020/24_11_2020_icu_occ.png)
...
On the other hand, let's look at ICU daily admissions (rather than occupancy). Looking at the decrease for the first wave, you can see they decreased much faster than they have been so far for the second wave.

![ICU admissions](/assets/images/2020/24_11_2020_icu_admit.png)

My hunch is this is because ICU stress is much more widespread than for the first wave, so big occupancy decreases in one region are being offset by continued increases in another.
