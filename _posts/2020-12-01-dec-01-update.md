...
How are things looking since the [my previous update](https://limegimlet.github.io/learning/blog/nov-27-update/){:target="_blank"}?

It's a mixed bag, notably for new positive cases.
